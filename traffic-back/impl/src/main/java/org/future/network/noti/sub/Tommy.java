 ...
 */
public class Tommy implements BroadcastListener {
    Logger LOG = LoggerFactory.getLogger(Tommy.class);
    @Override
    public void onBreakingNews(BreakingNews notification) {
        LOG.info("Tommy:"+notification.getDesc()+",Feel hopeless !!!!!!!!\n");
    }

    @Override
    public void onWeatherForecast(WeatherForecast notification) {
        LOG.info("Tommy:Date="+notification.getDate()+",Loaction="
