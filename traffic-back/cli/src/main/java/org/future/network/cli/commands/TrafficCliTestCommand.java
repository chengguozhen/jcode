 ...
 */
package org.future.network.cli.commands;
...
public class TrafficCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(TrafficCliTestCommand.class);
    protected final TrafficCliCommands service;

    public TrafficCliTestCommand(final TrafficCliCommands service) {
